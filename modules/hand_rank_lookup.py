...
class HandRankLookupTable(object):
    ...
    * 7-5-4-3-2 unsuited (worst hand possible)      => 7462
    ...
    def update_flush_lookup(self, starting_rank, ranks):
        rank = starting_rank
        for i in ranks:
            primary_product = CardInt.prime_product_from_rankbits(i)
    ...
    def set_lookups(self):
        ...
        number_of_card_ranks = len(CardInt.INT_RANKS)
    ...
    def set_four_of_a_kind(self, backwards_ranks):
        ...
        for i in backwards_ranks:
            ...
            for kicker_rank in kicker_ranks:
                primary_product = CardInt.PRIME_NUMBERS[i]**4 * \
                    CardInt.PRIME_NUMBERS[kicker_rank]
                self.unsuited_lookup[primary_product] = rank
                rank += 1
    ...
    def set_full_house(self, backwards_ranks):
        ...
        for i in backwards_ranks:
            ...
            for pair_rank in pair_ranks:
                primary_product = CardInt.PRIME_NUMBERS[i]**3 * \
                    CardInt.PRIME_NUMBERS[pair_rank]**2
                self.unsuited_lookup[primary_product] = rank
                rank += 1
    ...
    def set_three_of_a_kind(self, backwards_ranks):
        ...
        for i in backwards_ranks:
            ...
            for kicker_combo in kicker_combinations:
                ...
                primary_product = CardInt.PRIME_NUMBERS[i]**3 * \
                    CardInt.PRIME_NUMBERS[card_1] * \
                    CardInt.PRIME_NUMBERS[card_2]
                self.unsuited_lookup[primary_product] = rank
                rank += 1
    ...
    def set_two_pairs(self, backwards_ranks):
        ...
        for two_pair_combo in tow_pair_combinations:
            ...
            for kicker in kickers:
                primary_product = CardInt.PRIME_NUMBERS[pair_one]**2 * \
                    CardInt.PRIME_NUMBERS[pair_two]**2 * \
                    CardInt.PRIME_NUMBERS[kicker]
                self.unsuited_lookup[primary_product] = rank
                rank += 1
    ...
    def set_pairs(self, backwards_ranks):
        ...
        for pair_rank in backwards_ranks:
            ...
            for kicker_combo in kickers_combinations:
                ...
                primary_product = CardInt.PRIME_NUMBERS[pair_rank]**2 * CardInt.PRIME_NUMBERS[kicker_one] * \
                    CardInt.PRIME_NUMBERS[kicker_two] * \
                    CardInt.PRIME_NUMBERS[kicker_three]
                self.unsuited_lookup[primary_product] = rank
                rank += 1
